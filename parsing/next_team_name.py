...
def next_team_news(calendar_url):
    ...
    src = soup.find('div', class_='g-match-block-a__team-names')
    next_team_name = src.text.replace('Арсенал', '').strip()
    return next_team_name
...
if __name__ == '__main__':
    ...
    calendar_url = 'https://m.sports.ru/arsenal/calendar/'
